...
This repository contains solutions to the below tasks for Medisyn Labs.

### 1. Develop a solution to classify customer reviews as positive or negative.
### 2. Develop a model to predict the effectiveness rating of a medicine.
